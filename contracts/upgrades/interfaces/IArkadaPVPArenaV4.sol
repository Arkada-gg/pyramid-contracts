...
interface IArkadaPVPArenaV4 {
    ...
    /// @notice Emitted when the minEntryFee is updated
    /// @param caller Address that called the function
    /// @param newFee new min entry fee
    ...
    /// @notice Update min entry fee
    /// @dev Only callable by admin
    /// @param _newFee new min entry fee
    function setMinEntryFee(uint256 _newFee) external;
}
